...
class CertificatsController extends Controller
{
    ...
    public function certificat_inscription($Matri_Elev)
    {
        ...
        if (!$user) {
            ...
            $certificat_inscription = DB::table('Elèves as Elev')
            ...
            if ($certificat_inscription->isEmpty()) {
                return response()->json(
                    [
                        'success'  => false,
                        'status' => 401,
                ...
                return response()->json(
                    [
                        'success'  => true,
                        'status' => 200,
                        'certificat inscription' => $certificat_inscription,
                        'certificat frequentation' => $certificat_inscription
                    ],
                    200
                );
            }
